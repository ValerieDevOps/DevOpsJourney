...
* app.py was not found in the root directory (only inside app/)
...
* Python files located in the app layer
* Configuration files located in the config layer
* Log files located in the logs layer
...
Redundant naming issues were resolved.
...
* Created a full DevOps lab environment
...
* Introduced permission control using `chown`
...
A DevOps system is not built by commands — it is built by precision, structure, and correction under constraint.
